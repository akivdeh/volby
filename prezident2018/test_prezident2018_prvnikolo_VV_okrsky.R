...
pdf("prezident2018/test_prez2018_all_VV_okrsky.pdf", encoding="ISOLatin2.enc",width=6.5,height = 5)
plot_list
dev.off()


save(vysledky_vse, vysledky_souboj,rychlost,rychlost2, file = "prezident2018/data_prez2018_all_VVokrsky.RData")
